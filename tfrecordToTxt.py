...
#print(check_output(["ls", "./tfrecord_dataset/train"]).decode("utf8"))
...
filenames = []
video_lvl_record = []
for (dirpath, dirnames, filename) in walk("./yt8m_100/tfrecord_dataset/train/"):
	filenames = filename
	

for file in filenames:
  video_lvl_record.append("./yt8m_100/tfrecord_dataset/train/" + file)
...
with open('features.txt','w') as myfile:
        json.dump(new_mean_rgb, myfile)

myfile.close()

with open('labels.txt', 'w') as labelfile:
        json.dump(new_labels, labelfile)
